...
/**********************************************************/
	...
	*/
	...
	{
//		echo "\n Sending New Schedule Notification success is: " .$succ;
//		echo "\n Sending New Schedule Notification failure is: " .$fail;
...
//	echo "\n Sending New Schedule Notification failure is: " .$fail;
	...
	$response['message'] = "Sending New Schedule Notification";
	echo utf8_encode(json_encode($response));
